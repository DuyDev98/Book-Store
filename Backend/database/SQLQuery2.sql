...
-- =============================================
-- 1. XỬ LÝ BẢNG CHI TIẾT GIỎ HÀNG
...
CREATE TABLE chitietdonhang (
  ...
  FOREIGN KEY (MaDH) REFERENCES donhang(MaDH) ON DELETE CASCADE, -- (Tùy chọn: Xóa đơn hàng thì xóa luôn chi tiết)
  FOREIGN KEY (MaSach) REFERENCES sach(MaSach) ON DELETE CASCADE -- <--- DÒNG QUAN TRỌNG ĐÃ SỬA
);
